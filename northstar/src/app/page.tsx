    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg border border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-950">
        ...
        <div className="flex gap-3 p-5">
          ...
          <Link href="/reports" className="rounded border border-zinc-300 px-4 py-2 text-sm font-medium text-zinc-700 hover:bg-zinc-100 dark:border-zinc-700 dark:text-zinc-300 dark:hover:bg-zinc-800">
            View Reports
          </Link>
        </div>
      </div>
